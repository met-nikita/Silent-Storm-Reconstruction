...
{
	return SPixel8888( (unsigned char)Get255Range( color.r ), (unsigned char)Get255Range( color.g ), (unsigned char)Get255Range( color.b ), (unsigned char)Get255Range( color.a ) );
}
inline CVec4 GetCVec4Color( DWORD cr )
{
	return CVec4( (float)(cr >> 16 & 0xff), (float)(cr >> 8 & 0xff), (float)(cr & 0xff), (float)(cr >> 24 & 0xff) ) / 255;
}
////////////////////////////////////////////////////////////////////////////////////////////////////
