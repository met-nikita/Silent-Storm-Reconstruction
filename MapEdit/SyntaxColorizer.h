...
#define CLR_STRING	RGB(255,153,0)
...
protected:
	...
	struct SKeyword: public CObjectBase
	{
	private:
		OBJECT_BASIC_METHODS(SKeyword);
	public:
		string keyword;
		int  keylen;
		CHARFORMAT cf;
...
public:
	...
	void AddKeyword(LPCTSTR Keyword, COLORREF cr = CLR_KEYWORD, int grp = 0);
